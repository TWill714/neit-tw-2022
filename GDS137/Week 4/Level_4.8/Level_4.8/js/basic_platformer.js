...
function animate()
{
	...
	while(platform1.hitTestPoint(player.bottom()) && player.vy >=0 && key == false)
	{
		player.y--;
		player.vy = 0;
		player.canJump = true;
	}
	while(platform1.hitTestPoint(player.left()) && player.vx <=0 && key == false)
	{
		player.x++;
		player.vx = 0;
	}
	while(platform1.hitTestPoint(player.right()) && player.vx >=0 && key == false)
	{
		player.x--;
		player.vx = 0;
	}
	...
	while(platform1.hitTestPoint(player.right()) && player.vx >=0 && key == true)
	{
		platform1.y= 10000;
	}
