...
var caveData ={
	info:{
		layout:[
			...
			[9,10,x,24,x,27,x,28,x,25,x,28,27,x,x,27,24,x,28,25,27,25,x,x,x,24,x,28,25,x,27,25,x,12,13],
	...
	[		
			...
			},
			{
				fps:1,
				cycle:false,
				frames:[{width:64, height:64, startX:1728, startY:0}]
			},
			{
				fps:1,
				cycle:false,
				frames:[{width:64, height:64, startX:1792, startY:0}]
			},
			{
				fps:1,
				cycle:false,
				frames:[{width:64, height:64, startX:1856, startY:0}]
			},
			{
				fps:1,
				cycle:false,
				frames:[{width:64, height:64, startX:1920, startY:0}]
			},
			{
				fps:1,
				cycle:false,
				frames:[{width:64, height:64, startX:1984, startY:0}]
			},
			{
				fps:1,
				cycle:false,
				frames:[{width:64, height:64, startX:2048, startY:0}]
			},
			{
				fps:1,
				cycle:false,
				frames:[{width:64, height:64, startX:2112, startY:0}]
			},
			{
				fps:1,
				cycle:false,
				frames:[{width:64, height:64, startX:2176, startY:0}]
			},
			{
				fps:1,
				cycle:false,
				frames:[{width:64, height:64, startX:2240, startY:0}]
			},
			{
				fps:1,
				cycle:false,
				frames:[{width:64, height:64, startX:2304, startY:0}]
			}
	...
	var caveBackData ={
		info:{
			layout:[
				[14,15,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,16,17,18,19],
				[9,10,11,31,11,36,11,35,11,29,11,35,36,11,11,36,31,11,35,29,36,29,11,11,11,31,11,35,29,11,36,29,11,12,13],
				...
				[0,1,1,30,32,1,33,30,1,1,33,1,1,34,1,33,1,30,1,32,1,1,32,33,30,34,30,1,33,1,1,32,33,2,3]
		...
		var caveHitData={
			info:{
				layout:[
					...
					[9,10,x,31,x,36,x,35,x,29,x,35,36,x,x,36,31,x,35,29,36,29,x,x,x,31,x,35,29,x,36,29,x,12,13],
					[26,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,8],
					[26,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,8],
					[6,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,8],
					[x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,x,3],
