...
wiz.force=1
wiz.collisionPoints.left.x = -30
wiz.collisionPoints.right.x = 30
wiz.collisionPoints.top.x = 30
...
//A platform
var plat = new GameObject({width:192, height:167,y:canvas.height-148, color:"green"})
...
gameStates[`level1`] = function()
{
	...
	var platPattern = context.createPattern(plat.img, `no-repeat`);
